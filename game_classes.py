...
class VerbHolder():
    ...
    def get_verb_by_name(self, verb_name: str):
        ...
        return lambda *_, **__: {"client_print": f"You can not {verb_name} {self._name}"}
...
class Player(VerbHolder):
    ...
    def v_shout(self, game_state, phrase, *_, **__) -> dict:
        return {"client_print": f"you shouted {phrase}", "room_print": f"shouted {phrase}"}
